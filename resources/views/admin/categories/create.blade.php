...
<div class="mb-16">
    <h1 class="text-5xl font-black tracking-tight">
        ADD_<span class="text-brand">CATEGORY</span>
    </h1>

    <p class="text-zinc-500 font-mono text-xs uppercase tracking-widest mt-2">
        Create a new category for your vehicles
    </p>
</div>

<form action="{{ route('admin.categories.store') }}" method="POST" class="max-w-3xl space-y-12">
    @csrf
